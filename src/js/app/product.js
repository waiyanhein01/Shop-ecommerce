...
import { productGroup, productTemplate, shopCartGroup } from "../core/selectors"
...
export const createProduct = (productCard) => {
    ...
    template.querySelector(".product-card").setAttribute("product-id", productCard.id);
    ...
    template.querySelector(".card-rating").innerText = (`${productCard.rating.rate} \ ${productCard.rating.count}`);
